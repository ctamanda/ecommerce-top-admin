...
// Testes de integracao da camada Resource de Top.
@QuarkusTest
class TopResourceTest {

    @Test
    void deveCriarEBuscarTop() {
        // Cria entidades relacionadas para montar o Top.
        ...
        // Filtra por codigo para validar GET /find.
        given()
        .when()
        ...
        // Atualiza campos e associacoes para validar PUT.
    ...
    @Test
    void deveListarTops() {
        // Cria um top basico para garantir que a lista nao venha vazia.
        Long modeloId = criarModelo();
        Long tamanhoId = criarTamanho();
        Long corId = criarCor();
        Long tipoSustentacaoId = criarTipoSustentacao();
        ...
        Map<String, Object> dto = new HashMap<>();
        dto.put("nome", "Top Lista");
        dto.put("descricao", "Top para listar");
        dto.put("preco", 99.9);
        dto.put("codigo", "TP-LIST");
        dto.put("modeloId", modeloId);
        dto.put("tamanhoId", tamanhoId);
        dto.put("corId", corId);
        dto.put("tipoSustentacaoId", tipoSustentacaoId);
